...
namespace SPMTool.Extensions
{
    public static partial class Extensions
    {
	    ...
	    /// </summary>
	    private static Autodesk.AutoCAD.EditorInput.Editor Editor => Document.Editor;

	    /// <summary>
	    /// Get current <see cref="Autodesk.AutoCAD.DatabaseServices.Database"/>.
	    /// </summary>
	    private static Autodesk.AutoCAD.DatabaseServices.Database Database => Document.Database;
