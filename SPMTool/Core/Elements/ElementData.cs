...
//			    new TypedValue((int) DxfCode.ExtendedDataInteger32,   geometry.CrossSection.Width.Millimeters),   // 2
//			    new TypedValue((int) DxfCode.ExtendedDataReal,        geometry.CrossSection.Height.Millimeters)   // 3
//		    };
