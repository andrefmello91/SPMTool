...
[assembly: CommandClass(typeof(SPMTool.Results.DrawResults))]
    ...
    public class Results
    {
		...
		private void NodalDisplacements()
		{
			foreach (var nd in Nodes)
				nd.Displacements(dispVector);
		}

		public static class DrawResults
		{
			public static void Draw(Results results)
			{
				// Get the elements
				var nodes            = results.Nodes;
				var stringers     = results.Stringers;
				var panels          = results.Panels;
				var maxStringerForce = results.MaxStringerForce;
